...
async function loadDataFromGist() {
    ...
    try {
        ...
        if (localUsersCount !== cloudUsersCount) {
            await saveDataToGist();
        }
...
function mergeData(cloudData) {
    ...
    for (const round of allRounds) {
        ...
        const lList = scheduledMatches?.[round] || [];
        const map = new Map();
